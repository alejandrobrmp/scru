...
3. Read the latest relevant task spec or implemented outcome, if one exists.
...
- Avoid adding extra procedural ceremony inside the spec; focus on the concrete change to make.

## Output

Write the spec first, then summarize the file path and key constraints.
